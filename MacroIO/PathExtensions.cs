...
/// </para>
/// <para>
/// Empty path components are discarded.  This includes those before an initial separator, after a final separator,
/// or between two consecutive separators.
/// </para>
/// </remarks>
///
...
///
public static bool
IsDescendantOf(string path, string possibleAncestorPath)
{
    Guard.NotNull(path, nameof(path));
...
///
public static string
GetPathFromAncestor(string path, string ancestorPath)
{
    Guard.NotNull(path, nameof(path));
